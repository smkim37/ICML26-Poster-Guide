# ICML 2026 Poster Guide — 마스터 플랜 (구현 이력)

> **✅ 전 페이즈 완료 (2026-07-06).** 이 문서는 구현 이력 기록이며, 현재 작업 규칙·상태는 CLAUDE.md가 기준.

관심 포스터 **137편**(핵심 30 / 관련 52 / 참고 55)을 일자·세션·포스터 번호 동선 순으로 관람하기 위한 개인용 모바일 우선 웹앱.

- **라이브 URL**: https://sumin-kim.com/ICML26-Poster-Guide/ (= smkim37.github.io/ICML26-Poster-Guide)
...
| 2. 리스트+상세 | ✅ 완료 | d11927f |
| 3. 검색·필터·유저데이터 | ✅ 완료 | ab21870 |
| 4. 시간·일정·통계 | ✅ 완료 | 5663c73 |
| 5. 다크모드·설정·반응형 | ✅ 완료 | 7f823d6 |
| 6. PWA·QA | ✅ 완료 | 3d102d6 |
| 7. 리뷰 수정 13건 + 개인 모드(전 UI 공개 + 잠금 시 안내 팝업, 유지 10분→현재 3시간 — docs/01 §10) | ✅ 완료 | |
| 8. 팝업 단계형 안내·설정 최상단 이동 + 미정 15편 재확인(7/6, 전원 미배정) | ✅ 완료 | |
| 9. 유지 3시간 변경 + 코드·문서 최종 정리 | ✅ 완료 | |
